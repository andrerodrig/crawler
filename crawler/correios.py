...
class HtmlObject:
    ...
    def ufs(self):
        ...
        if not self.__ufs:
            ...
            options = [
                uf.text for uf
                in select_ufs.find_elements_by_tag_name(self.tag_name_ufs)]
    ...
    def uf_locations(self):
        ...
        location_table = self.driver.find_element_by_xpath(
            self.location_table_xpath)
    ...
    def export_jsonl(self, data, filename):
        ...
        pd.to_json(filename, orient='records', lines=True)
    ...
    def search_all_ufs(self):
        ...
        for uf in self.ufs:
            ...
            breakpoint()
            self.export_json(df_locations, f'data/{uf}.jsonl')
            self.driver.back()
